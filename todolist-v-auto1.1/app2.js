...
const Strategy = require("passport-local").createStrategy
  ...
  if(req.isAuthenticated()) {
    Item.find({}, function(err, foundItems) {
      ...
      if (foundItems.length === false){
        ...
        res.render("list", {User: req.user, listTitle: "Today", newListItems: foundItems})
      }
    })
  } else {
    res.redirect("/")
...
app.post("/home", function(req, res){
  ...
  var todo = new Todo({name: req.body["todo.name"], name1: req.body["todo.name1"]});
